...
import { createContext, useContext, forwardRef, useRef, useEffect, useState, memo, Fragment, useCallback, useId, Children, lazy, Suspense, useMemo, useSyncExternalStore } from "react";
...
const dark = {
  ...
  primary: "oklch(70% 0.1 167)",
  accent: "oklch(70% 0.1 193)",
...
const Divider = ({
  ...
  "div",
  {
    className: classes(styles$m.divider, className),
    style: cssProps(
      {
        lineWidth,
        lineHeight,
    ...
    ...rest,
    children: [
      /* @__PURE__ */ jsx("div", { className: styles$m.line, "data-collapsed": collapsed }),
      /* @__PURE__ */ jsx(
        "div",
        {
          className: styles$m.notch,
...
const Footer = ({ className }) => /* @__PURE__ */ jsx("footer", { className: classes(styles$k.footer, className), children: /* @__PURE__ */ jsxs(Text, { size: "s", align: "center", children: [
  ...
  /* @__PURE__ */ jsx(Link, { secondary: true, className: styles$k.link, href: "/humans.txt", target: "_self" })
] }) });
...
const post$1 = "_post_kr7uo_20";
const header$2 = "_header_kr7uo_44";
...
const timecode$1 = "_timecode_kr7uo_233";
...
const Post = ({ children, title: title2, date: date2, banner: banner2, timecode: timecode2 }) => {
  ...
  return /* @__PURE__ */ jsxs("article", { className: styles$i.post, children: [
    /* @__PURE__ */ jsxs(Section, { children: [
      banner2 && /* @__PURE__ */ jsxs("div", { className: styles$i.banner, ref: imageRef, children: [
        /* @__PURE__ */ jsx("div", { className: styles$i.bannerImage, children: /* @__PURE__ */ jsx(Image$1, { role: "presentation", src: banner2, placeholder: placeholder2, alt: "" }) }),
        /* @__PURE__ */ jsx("div", { className: styles$i.bannerImageBlur, children: /* @__PURE__ */ jsx(
          Image$1,
          {
            role: "presentation",
            src: placeholder2,
      ...
      /* @__PURE__ */ jsx("header", { className: styles$i.header, children: /* @__PURE__ */ jsxs("div", { className: styles$i.headerText, children: [
        /* @__PURE__ */ jsx(Transition, { in: true, timeout: msToNum(tokens.base.durationM), children: ({ visible, nodeRef }) => /* @__PURE__ */ jsxs("div", { className: styles$i.date, ref: nodeRef, children: [
          /* @__PURE__ */ jsx(Divider, { notchWidth: "64px", notchHeight: "8px", collapsed: !visible }),
          /* @__PURE__ */ jsx(Text, { className: styles$i.dateText, "data-visible": visible, children: dateTime })
        ] }) }),
        /* @__PURE__ */ jsx(Heading, { level: 2, as: "h1", className: styles$i.title, "aria-label": title2, children: title2.split(" ").map((word2, index2) => /* @__PURE__ */ jsx("span", { className: styles$i.titleWordWrapper, children: /* @__PURE__ */ jsxs(
          "span",
          {
            className: styles$i.titleWord,
        ...
        /* @__PURE__ */ jsxs("div", { className: styles$i.details, children: [
          ...
          /* @__PURE__ */ jsx("div", { className: styles$i.timecode, children: timecode2 })
        ] })
      ] }) })
    ] }),
    /* @__PURE__ */ jsx(Section, { className: styles$i.wrapper, id: "postContent", tabIndex: -1, children: /* @__PURE__ */ jsx(Text, { as: "div", size: "l", className: styles$i.content, children }) }),
    /* @__PURE__ */ jsx(Footer, {})
  ] });
};
...
const Code = (props) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: styles$h.code, "data-theme": theme, children: [
    !!lang2 && /* @__PURE__ */ jsx(Text, { secondary: true, size: "s", className: styles$h.lang, children: lang2 }),
    /* @__PURE__ */ jsx("pre", { ref: elementRef, ...props }),
    /* @__PURE__ */ jsx("div", { className: styles$h.actions, children: /* @__PURE__ */ jsx(Button, { iconOnly: true, onClick: handleCopy, "aria-label": "Copy", children: /* @__PURE__ */ jsxs("span", { className: styles$h.copyIcon, children: [
...
const List = ({ ordered, children, className, ...rest }) => {
  ...
  return /* @__PURE__ */ jsx(Element, { className: classes(styles$g.list, className), ...rest, children });
};
const ListItem = ({ children, ...rest }) => {
  return /* @__PURE__ */ jsx("li", { className: styles$g.item, ...rest, children });
};
const heading$1 = "_heading_69uyj_2";
const paragraph = "_paragraph_69uyj_14";
const list$1 = "_list_69uyj_14";
...
const PostHeadingLink = ({ id }) => {
  return /* @__PURE__ */ jsx(Link$1, { className: styles$f.headingLink, to: `#${id}`, "aria-label": "Link to heading", children: /* @__PURE__ */ jsx(Icon, { icon: "link" }) });
};
const PostH1 = ({ children, id, ...rest }) => /* @__PURE__ */ jsxs(Heading, { className: styles$f.heading, id, level: 2, as: "h1", ...rest, children: [
  /* @__PURE__ */ jsx(PostHeadingLink, { id }),
  children
] });
const PostH2 = ({ children, id, ...rest }) => /* @__PURE__ */ jsxs(Heading, { className: styles$f.heading, id, level: 3, as: "h2", ...rest, children: [
  /* @__PURE__ */ jsx(PostHeadingLink, { id }),
  children
] });
const PostH3 = ({ children, id, ...rest }) => /* @__PURE__ */ jsxs(Heading, { className: styles$f.heading, id, level: 4, as: "h3", ...rest, children: [
  /* @__PURE__ */ jsx(PostHeadingLink, { id }),
  children
] });
const PostH4 = ({ children, id, ...rest }) => /* @__PURE__ */ jsxs(Heading, { className: styles$f.heading, id, level: 5, as: "h4", ...rest, children: [
  /* @__PURE__ */ jsx(PostHeadingLink, { id }),
  children
] });
const PostParagraph = ({ children, ...rest }) => {
  ...
  return /* @__PURE__ */ jsx(Text, { className: styles$f.paragraph, size: "l", as: "p", ...rest, children });
};
const PostLink = ({ ...props }) => /* @__PURE__ */ jsx(Link, { ...props });
const PostUl = (props) => {
  return /* @__PURE__ */ jsx(List, { className: styles$f.list, ...props });
};
const PostOl = (props) => {
  return /* @__PURE__ */ jsx(List, { className: styles$f.list, ordered: true, ...props });
};
const PostLi = ({ children, ...props }) => {
  return /* @__PURE__ */ jsx(ListItem, { ...props, children });
};
const PostCode = ({ children, ...rest }) => /* @__PURE__ */ jsx("code", { className: styles$f.code, ...rest, children });
const PostPre = (props) => {
  return /* @__PURE__ */ jsx("div", { className: styles$f.pre, children: /* @__PURE__ */ jsx(Code, { ...props }) });
};
const PostBlockquote = (props) => {
  return /* @__PURE__ */ jsx("blockquote", { className: styles$f.blockquote, ...props });
};
const PostHr = (props) => {
  return /* @__PURE__ */ jsx("hr", { className: styles$f.hr, ...props });
};
const PostStrong = (props) => {
  return /* @__PURE__ */ jsx("strong", { className: styles$f.strong, ...props });
};
...
const Embed = ({ src }) => {
  return /* @__PURE__ */ jsx("div", { className: styles$f.embed, children: /* @__PURE__ */ jsx("iframe", { src, loading: "lazy", title: "Embed" }) });
};
const postMarkdown = {
  h1: PostH1,
  h2: PostH2,
...
async function loader$3({ request }) {
  ...
  const module = await __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "../articles.hello-world.mdx": () => Promise.resolve().then(() => route5), "../articles.modern-styling-in-react.mdx": () => Promise.resolve().then(() => route2) }), `../articles.${slug}.mdx`, 2);
...
const ProjectImage = ({ className, alt, ...rest }) => /* @__PURE__ */ jsx("div", { className: classes(styles$e.image, className), children: /* @__PURE__ */ jsx(Image$1, { reveal: true, alt, delay: 300, ...rest }) });
...
const ProjectSectionColumns = ({ className, centered, ...rest }) => /* @__PURE__ */ jsx(
  ...
  {
    className: classes(styles$e.sectionColumns, className),
...
const Carousel = lazy(
  () => import("./index-BVTSWtgT.js").then((module) => ({ default: module.Carousel }))
);
const Armor = lazy(() => import("./armor-DBHTTqyp.js").then((module) => ({ default: module.Armor })));
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs(ProjectContainer, { children: [
      ...
      /* @__PURE__ */ jsx(ProjectSection, { children: /* @__PURE__ */ jsxs(ProjectSectionColumns, { children: [
        /* @__PURE__ */ jsx("div", { className: styles$d.armor, children: /* @__PURE__ */ jsx(Suspense, { children: /* @__PURE__ */ jsx(Armor, { alt: "3D model of the Volkihar Knight armor" }) }) }),
        /* @__PURE__ */ jsxs("div", { className: styles$d.textSection, children: [
      ...
      /* @__PURE__ */ jsx(ProjectSection, { children: /* @__PURE__ */ jsxs(ProjectSectionContent, { children: [
        /* @__PURE__ */ jsx("div", { className: styles$d.logoContainer, children: /* @__PURE__ */ jsx(
          VolkiharLogo,
          {
            role: "img",
      ...
      children: /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: styles$c.options, children: [
...
const Earth = lazy(() => import("./earth-DBIGdaqb.js").then((module) => ({ default: module.Earth })));
const EarthSection = lazy(
  () => import("./earth-DBIGdaqb.js").then((module) => ({ default: module.EarthSection }))
);
...
async function getPosts() {
  const modules = /* @__PURE__ */ Object.assign({ "../articles.hello-world.mdx": route5, "../articles.modern-styling-in-react.mdx": route2 });
...
function ArticlesPost({ slug, frontmatter: frontmatter2, timecode: timecode2, index: index2 }) {
  ...
  return /* @__PURE__ */ jsxs(
    "article",
    {
      className: styles$a.post,
      "data-featured": !!featured,
      style: index2 !== void 0 ? cssProps({ delay: index2 * 100 + 200 }) : void 0,
      children: [
        featured && /* @__PURE__ */ jsx(Text, { className: styles$a.postLabel, size: "s", children: "Featured" }),
        featured && !!banner2 && /* @__PURE__ */ jsx("div", { className: styles$a.postImage, children: /* @__PURE__ */ jsx(
          Image$1,
          {
            noPauseButton: true,
        ...
        /* @__PURE__ */ jsx(
          Link$1,
          {
            ...
            prefetch: "intent",
            to: `/articles/${slug}`,
            className: styles$a.postLink,
            onMouseEnter: handleMouseEnter,
            onMouseLeave: handleMouseLeave,
            children: /* @__PURE__ */ jsxs("div", { className: styles$a.postDetails, children: [
              /* @__PURE__ */ jsxs("div", { "aria-hidden": true, className: styles$a.postDate, children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: styles$a.postFooter, children: [
                /* @__PURE__ */ jsx(Button, { secondary: true, iconHoverShift: true, icon: "chevron-right", as: "div", children: "Read article" }),
                /* @__PURE__ */ jsx(Text, { className: styles$a.timecode, size: "s", children: timecode2 })
              ] })
            ] })
          }
        ),
        featured && /* @__PURE__ */ jsx(Text, { "aria-hidden": true, className: styles$a.postTag, size: "s", children: "477" })
      ]
    }
  );
}
function SkeletonPost({ index: index2 }) {
  return /* @__PURE__ */ jsx(
    ...
    {
      "aria-hidden": "true",
      className: classes(styles$a.post, styles$a.skeleton),
      "data-featured": "false",
      style: index2 !== void 0 ? cssProps({ delay: index2 * 100 + 200 }) : void 0,
      children: /* @__PURE__ */ jsx("div", { className: styles$a.postLink, children: /* @__PURE__ */ jsxs("div", { className: styles$a.postDetails, children: [
        /* @__PURE__ */ jsxs("div", { "aria-hidden": true, className: styles$a.postDate, children: [
          /* @__PURE__ */ jsx(Divider, { notchWidth: "64px", notchHeight: "8px" }),
          "Coming soon..."
        ] }),
        /* @__PURE__ */ jsx(
          Heading,
          {
            className: styles$a.skeletonBone,
            as: "h2",
            level: 4,
        ...
        /* @__PURE__ */ jsxs("div", { className: styles$a.postFooter, children: [
          ...
          /* @__PURE__ */ jsx(Text, { className: styles$a.timecode, size: "s", children: "00:00:00:00" })
        ] })
      ] }) })
    }
  );
...
function Articles() {
  ...
  const postsHeader = /* @__PURE__ */ jsxs("header", { className: styles$a.header, children: [
    /* @__PURE__ */ jsx(Heading, { className: styles$a.heading, level: 5, as: "h1", children: /* @__PURE__ */ jsx(DecoderText, { text: "Latest articles" }) }),
    /* @__PURE__ */ jsx(Barcode, { className: styles$a.barcode })
  ] });
  const postList = /* @__PURE__ */ jsxs("div", { className: styles$a.list, children: [
  ...
  return /* @__PURE__ */ jsxs("article", { className: styles$a.articles, children: [
    /* @__PURE__ */ jsxs(Section, { className: styles$a.content, children: [
      !isSingleColumn && /* @__PURE__ */ jsxs("div", { className: styles$a.grid, children: [
        postList,
        featuredPost
      ] }),
      isSingleColumn && /* @__PURE__ */ jsxs("div", { className: styles$a.grid, children: [
...
const sprTexture1 = "/assets/ALAMAZING-WORD-GAME-DohqKYq0.png";
function subscribe() {
  return () => {
  };
}
...
const intro = "_intro_15kxq_1";
const text = "_text_15kxq_9";
const name = "_name_15kxq_36";
const title$2 = "_title_15kxq_74";
const row$1 = "_row_15kxq_78";
const word = "_word_15kxq_107";
const introTextReveal = "_introTextReveal_15kxq_1";
const line = "_line_15kxq_199";
const introLine = "_introLine_15kxq_1";
const scrollIndicator = "_scrollIndicator_15kxq_248";
const introScrollIndicator = "_introScrollIndicator_15kxq_1";
const mobileScrollIndicator = "_mobileScrollIndicator_15kxq_315";
const introMobileScrollIndicator = "_introMobileScrollIndicator_15kxq_1";
const styles$5 = {
  intro,
  text,
  name,
...
lazy(
  () => import("./displacement-sphere-BFPrHJ23.js").then((module) => ({ default: module.DisplacementSphere }))
);
...
const profileImgLarge = "/assets/profile-Cd_Pxj3W.jpg";
const profileImgPlaceholder = "/assets/profile-placeholder-DOgU6wR2.jpg";
const profileImg = "/assets/profile-Cd_Pxj3W.jpg";
const katakana = "/assets/katakana-DR-bVyLd.svg";
const profile = "_profile_v8cfi_1";
const content$1 = "_content_v8cfi_37";
const column = "_column_v8cfi_50";
const title$1 = "_title_v8cfi_59";
const description$1 = "_description_v8cfi_70";
const tag = "_tag_v8cfi_80";
const tagText = "_tagText_v8cfi_93";
const image = "_image_v8cfi_114";
const svg$1 = "_svg_v8cfi_119";
const button$1 = "_button_v8cfi_135";
const styles$4 = {
  profile,
  content: content$1,
  column,
...
const ProfileText = ({ visible, titleId }) => /* @__PURE__ */ jsxs(Fragment, { children: [
  ...
  /* @__PURE__ */ jsxs(Text, { className: styles$4.description, "data-visible": visible, size: "l", as: "p", children: [
    "I’m ALJABRI known at the office as ALJ, currently I live in SINGAPORE working as a Senior Software Engineer at",
    " ",
    /* @__PURE__ */ jsx(Link, { href: "https://www.viseo.com/en/", children: "VISEO ASIA" }),
    ". I am perpetually preoccupied with thoughts of my son, ALJMAR - My coding buddy."
  ] }),
  /* @__PURE__ */ jsx(Text, { className: styles$4.description, "data-visible": visible, size: "l", as: "p", children: "A Dynamic Mobile App Engineer with a robust skill set spanning native Android, React Native (Android/iOS), web development (PHP: Laravel, CodeIgniter, WordPress, React), and Python. Proficient in Java/Kotlin, React Native JavaScript/TypeScript, and Python programming languages. Demonstrates excellence in Object-Oriented Programming, Agile Scrum methodologies, and the Software Development Life Cycle (SDLC). Successfully deployed high-value applications to prestigious bank clients, showcasing precision and versatility in project delivery." })
] });
  ...
  return /* @__PURE__ */ jsx(
    Section,
    {
      ...
      children: /* @__PURE__ */ jsx(Transition, { in: visible || focused, timeout: 0, children: ({ visible: visible2, nodeRef }) => /* @__PURE__ */ jsxs("div", { className: styles$4.content, ref: nodeRef, children: [
        /* @__PURE__ */ jsx("div", { className: styles$4.column, children: /* @__PURE__ */ jsx(ProfileText, { visible: visible2, titleId }) }),
...
const Model = lazy(
  () => import("./index-DCP5wLLH.js").then((module) => ({ default: module.Model }))
);
...
const meta$2 = () => {
  return baseMeta({
    ...
    description: `Design portfolio of ${config.name} — a Software Engineer working on web & mobile apps with a focus on experience design, and accessibility.`
  });
};
const Home = () => {
  ...
  useEffect(() => {
    const sections = [intro2, projectOne, details2];
  ...
  return /* @__PURE__ */ jsxs("div", { className: styles$2.home, children: [
    ...
    /* @__PURE__ */ jsx(
      ProjectSummary,
      {
        ...
        Game: true,
        Mobile: true,
        title: "Alamazing Word Game",
        description: "Mobile App: Tech: React Native - Typescript, Android, iOS. A Simple Word Game App, a player can select a category (Cities, Foods and Animals) and attempt to guess a randomized word based on the given hint.",
        ...
        model: {
          ...
          textures: [
            {
              srcSet: `${sprTexture1} 1280w, ${sprTexture1} 2560w`,
...
const serverManifest = { "entry": { "module": "/assets/entry.client-k3vxMEN-.js", "imports": ["/assets/jsx-runtime-CbkKSL4Y.js", "/assets/components-BP3zyvdP.js"], "css": [] }, "routes": { "root": { "id": "root", "parentId": void 0, "path": "", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": true, "module": "/assets/root-DrDbnzNw.js", "imports": ["/assets/jsx-runtime-CbkKSL4Y.js", "/assets/components-BP3zyvdP.js", "/assets/heading-BKkj-knJ.js", "/assets/index-CQBIJVQe.js", "/assets/visually-hidden-BFqrBCCe.js", "/assets/use-spring-mJt5bGGW.js", "/assets/decoder-text-BKyrVvd3.js", "/assets/image-CKvKuLoN.js", "/assets/error-q0ATHc5x.js", "/assets/useScrollToHash-jYlNwIpY.js", "/assets/useWindowSize-MDlHk0QV.js", "/assets/config-DnEgSU9V.js"], "css": ["/assets/heading-DxmoR0-i.css", "/assets/image-CQFqa4Pm.css", "/assets/visually-hidden-DZKbrLgw.css", "/assets/decoder-text-DSqD8fOZ.css", "/assets/error-CmEnn51Q.css", "/assets/root-D74oWFC6.css"] }, "routes/articles.modern-styling-in-react": { "id": "routes/articles.modern-styling-in-react", "parentId": "routes/articles", "path": "modern-styling-in-react", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/articles.modern-styling-in-react-ZK5eUDbO.js", "imports": ["/assets/jsx-runtime-CbkKSL4Y.js", "/assets/index-BzxHGz_K.js"], "css": [] }, "routes/projects.volkihar-knight": { "id": "routes/projects.volkihar-knight", "parentId": "root", "path": "projects/volkihar-knight", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-Bbwp7QbR.js", "imports": ["/assets/jsx-runtime-CbkKSL4Y.js", "/assets/components-BP3zyvdP.js", "/assets/heading-BKkj-knJ.js", "/assets/config-DnEgSU9V.js", "/assets/image-CKvKuLoN.js", "/assets/meta-BrRb_X7k.js", "/assets/useParallax-DiD1NSrh.js", "/assets/preload-helper-BqjOJQfC.js", "/assets/project-BVtIlzCM.js"], "css": ["/assets/heading-DxmoR0-i.css", "/assets/meta-CUrllC_C.css", "/assets/image-CQFqa4Pm.css", "/assets/project-D3JpM_tk.css", "/assets/route-BT5UbU5w.css"] }, "routes/projects.smart-sparrow": { "id": "routes/projects.smart-sparrow", "parentId": "root", "path": "projects/smart-sparrow", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-DCZFr3RQ.js", "imports": ["/assets/jsx-runtime-CbkKSL4Y.js", "/assets/components-BP3zyvdP.js", "/assets/heading-BKkj-knJ.js", "/assets/config-DnEgSU9V.js", "/assets/image-CKvKuLoN.js", "/assets/meta-BrRb_X7k.js", "/assets/useParallax-DiD1NSrh.js", "/assets/preload-helper-BqjOJQfC.js", "/assets/spr-lesson-builder-dark-placeholder-CxlvWxWS.js", "/assets/visually-hidden-BFqrBCCe.js", "/assets/project-BVtIlzCM.js"], "css": ["/assets/heading-DxmoR0-i.css", "/assets/meta-CUrllC_C.css", "/assets/image-CQFqa4Pm.css", "/assets/visually-hidden-DZKbrLgw.css", "/assets/project-D3JpM_tk.css", "/assets/route-PiXNUkZG.css"] }, "routes/articles.hello-world": { "id": "routes/articles.hello-world", "parentId": "routes/articles", "path": "hello-world", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/articles.hello-world-2zvzKMrX.js", "imports": ["/assets/jsx-runtime-CbkKSL4Y.js", "/assets/index-BzxHGz_K.js"], "css": [] }, "routes/articles_._index": { "id": "routes/articles_._index", "parentId": "root", "path": "articles", "index": true, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-CKP6beA0.js", "imports": ["/assets/jsx-runtime-CbkKSL4Y.js", "/assets/components-BP3zyvdP.js", "/assets/heading-BKkj-knJ.js", "/assets/config-DnEgSU9V.js", "/assets/index-CQBIJVQe.js", "/assets/visually-hidden-BFqrBCCe.js", "/assets/use-spring-mJt5bGGW.js", "/assets/meta-BrRb_X7k.js", "/assets/decoder-text-BKyrVvd3.js", "/assets/divider-Dbshg1YA.js", "/assets/image-CKvKuLoN.js", "/assets/useWindowSize-MDlHk0QV.js", "/assets/date-DvyCAN0s.js"], "css": ["/assets/heading-DxmoR0-i.css", "/assets/meta-CUrllC_C.css", "/assets/visually-hidden-DZKbrLgw.css", "/assets/decoder-text-DSqD8fOZ.css", "/assets/divider-CJ0zz9kw.css", "/assets/image-CQFqa4Pm.css", "/assets/route-DtSYASGB.css"] }, "routes/projects.slice": { "id": "routes/projects.slice", "parentId": "root", "path": "projects/slice", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-B_crqJza.js", "imports": ["/assets/jsx-runtime-CbkKSL4Y.js", "/assets/components-BP3zyvdP.js", "/assets/heading-BKkj-knJ.js", "/assets/config-DnEgSU9V.js", "/assets/image-CKvKuLoN.js", "/assets/meta-BrRb_X7k.js", "/assets/useParallax-DiD1NSrh.js", "/assets/project-BVtIlzCM.js"], "css": ["/assets/heading-DxmoR0-i.css", "/assets/meta-CUrllC_C.css", "/assets/image-CQFqa4Pm.css", "/assets/project-D3JpM_tk.css", "/assets/route-BMFIlMHl.css"] }, "routes/api.set-theme": { "id": "routes/api.set-theme", "parentId": "root", "path": "api/set-theme", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/api.set-theme-l0sNRNKZ.js", "imports": [], "css": [] }, "routes/articles": { "id": "routes/articles", "parentId": "root", "path": "articles", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-CotaPX4x.js", "imports": ["/assets/jsx-runtime-CbkKSL4Y.js", "/assets/components-BP3zyvdP.js", "/assets/heading-BKkj-knJ.js", "/assets/config-DnEgSU9V.js", "/assets/divider-Dbshg1YA.js", "/assets/meta-BrRb_X7k.js", "/assets/image-CKvKuLoN.js", "/assets/useParallax-DiD1NSrh.js", "/assets/useScrollToHash-jYlNwIpY.js", "/assets/clamp-e7DugykH.js", "/assets/date-DvyCAN0s.js", "/assets/list-BP4_dVx1.js", "/assets/index-BzxHGz_K.js"], "css": ["/assets/heading-DxmoR0-i.css", "/assets/divider-CJ0zz9kw.css", "/assets/meta-CUrllC_C.css", "/assets/image-CQFqa4Pm.css", "/assets/list-DkijDrbu.css", "/assets/route-CMd6_K8x.css"] }, "routes/contact": { "id": "routes/contact", "parentId": "root", "path": "contact", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-86JjW2hC.js", "imports": ["/assets/jsx-runtime-CbkKSL4Y.js", "/assets/components-BP3zyvdP.js", "/assets/heading-BKkj-knJ.js", "/assets/index-CQBIJVQe.js", "/assets/visually-hidden-BFqrBCCe.js", "/assets/use-spring-mJt5bGGW.js", "/assets/config-DnEgSU9V.js", "/assets/decoder-text-BKyrVvd3.js", "/assets/divider-Dbshg1YA.js", "/assets/meta-BrRb_X7k.js"], "css": ["/assets/heading-DxmoR0-i.css", "/assets/visually-hidden-DZKbrLgw.css", "/assets/decoder-text-DSqD8fOZ.css", "/assets/divider-CJ0zz9kw.css", "/assets/meta-CUrllC_C.css", "/assets/route-DZ4V55Yk.css"] }, "routes/home": { "id": "routes/home", "parentId": "root", "path": "home", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-DQid4xSo.js", "imports": ["/assets/jsx-runtime-CbkKSL4Y.js", "/assets/components-BP3zyvdP.js", "/assets/heading-BKkj-knJ.js", "/assets/config-DnEgSU9V.js", "/assets/index-CQBIJVQe.js", "/assets/visually-hidden-BFqrBCCe.js", "/assets/use-spring-mJt5bGGW.js", "/assets/spr-lesson-builder-dark-placeholder-CxlvWxWS.js", "/assets/meta-BrRb_X7k.js", "/assets/preload-helper-BqjOJQfC.js", "/assets/decoder-text-BKyrVvd3.js", "/assets/image-CKvKuLoN.js", "/assets/useScrollToHash-jYlNwIpY.js", "/assets/divider-Dbshg1YA.js", "/assets/useWindowSize-MDlHk0QV.js", "/assets/route-tqs4pQzr.js"], "css": ["/assets/heading-DxmoR0-i.css", "/assets/meta-CUrllC_C.css", "/assets/visually-hidden-DZKbrLgw.css", "/assets/decoder-text-DSqD8fOZ.css", "/assets/image-CQFqa4Pm.css", "/assets/divider-CJ0zz9kw.css", "/assets/route-BCLTtNO9.css"] }, "routes/uses": { "id": "routes/uses", "parentId": "root", "path": "uses", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-DKeu9r4d.js", "imports": ["/assets/jsx-runtime-CbkKSL4Y.js", "/assets/components-BP3zyvdP.js", "/assets/heading-BKkj-knJ.js", "/assets/config-DnEgSU9V.js", "/assets/image-CKvKuLoN.js", "/assets/meta-BrRb_X7k.js", "/assets/useParallax-DiD1NSrh.js", "/assets/list-BP4_dVx1.js", "/assets/project-BVtIlzCM.js"], "css": ["/assets/heading-DxmoR0-i.css", "/assets/meta-CUrllC_C.css", "/assets/list-DkijDrbu.css", "/assets/image-CQFqa4Pm.css", "/assets/project-D3JpM_tk.css", "/assets/route-CJWqkCSj.css"] }, "routes/$": { "id": "routes/$", "parentId": "root", "path": "*", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": true, "module": "/assets/_-JJZvq_IS.js", "imports": ["/assets/jsx-runtime-CbkKSL4Y.js", "/assets/components-BP3zyvdP.js", "/assets/heading-BKkj-knJ.js", "/assets/index-CQBIJVQe.js", "/assets/visually-hidden-BFqrBCCe.js", "/assets/use-spring-mJt5bGGW.js", "/assets/decoder-text-BKyrVvd3.js", "/assets/image-CKvKuLoN.js", "/assets/error-q0ATHc5x.js"], "css": ["/assets/heading-DxmoR0-i.css", "/assets/visually-hidden-DZKbrLgw.css", "/assets/decoder-text-DSqD8fOZ.css", "/assets/image-CQFqa4Pm.css", "/assets/error-CmEnn51Q.css"] }, "routes/home/route": { "id": "routes/home/route", "parentId": "root", "path": "/", "index": true, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-DQid4xSo.js", "imports": ["/assets/jsx-runtime-CbkKSL4Y.js", "/assets/components-BP3zyvdP.js", "/assets/heading-BKkj-knJ.js", "/assets/config-DnEgSU9V.js", "/assets/index-CQBIJVQe.js", "/assets/visually-hidden-BFqrBCCe.js", "/assets/use-spring-mJt5bGGW.js", "/assets/spr-lesson-builder-dark-placeholder-CxlvWxWS.js", "/assets/meta-BrRb_X7k.js", "/assets/preload-helper-BqjOJQfC.js", "/assets/decoder-text-BKyrVvd3.js", "/assets/image-CKvKuLoN.js", "/assets/useScrollToHash-jYlNwIpY.js", "/assets/divider-Dbshg1YA.js", "/assets/useWindowSize-MDlHk0QV.js", "/assets/route-tqs4pQzr.js"], "css": ["/assets/heading-DxmoR0-i.css", "/assets/meta-CUrllC_C.css", "/assets/visually-hidden-DZKbrLgw.css", "/assets/decoder-text-DSqD8fOZ.css", "/assets/image-CQFqa4Pm.css", "/assets/divider-CJ0zz9kw.css", "/assets/route-BCLTtNO9.css"] } }, "url": "/assets/manifest-2f9b6236.js", "version": "2f9b6236" };
